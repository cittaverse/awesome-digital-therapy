...
| **[Narrative Scorer](https://github.com/cittaverse/narrative-scorer)**       | 六维叙事质量评分器 v0.6.2 — 维度校准 + 72测试 + 15样本benchmark + CI + [nlg-metricverse插件](https://github.com/disi-unibo-nlp/nlg-metricverse/pull/11)         | 中文优化   | 🟢 本组织  |
