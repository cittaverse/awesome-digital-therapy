...
| **[Narrative Scorer](https://github.com/cittaverse/narrative-scorer)**       | 六维叙事质量评分器 v0.6.4 — 情感词库终版 (90 词，含基本情感表达 + 亲情词) + 年日农历时间识别 — 维度校准 + 72测试 + 15样本benchmark + CI + [nlg-metricverse插件](https://github.com/disi-unibo-nlp/nlg-metricverse/pull/11)         | 中文优化   | 🟢 本组织  |
